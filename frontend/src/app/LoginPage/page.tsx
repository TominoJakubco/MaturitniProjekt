...
export default function LoginPage() {
    ...
    return (
        <div style={{
            ...
            <div style={{ position: "absolute", top: "20%", right: "20%", width: "350px", height: "350px", background: "radial-gradient(circle, rgba(59,130,246,0.14), transparent 70%)", borderRadius: "50%", filter: "blur(80px)", pointerEvents: "none" }} />
            <div style={{ position: "absolute", bottom: "20%", left: "15%", width: "280px", height: "280px", background: "radial-gradient(circle, rgba(14,165,233,0.1), transparent 70%)", borderRadius: "50%", filter: "blur(80px)", pointerEvents: "none" }} />
            ...
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "32px", gap: "12px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "9px" }}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M3 3h7v7H3V3zm11 0h7v7h-7V3zM3 14h7v7H3v-7zm11 0h7v7h-7v-7z" fill="url(#lg-l)" />
                            <defs>
                                <linearGradient id="lg-l" x1="3" y1="3" x2="21" y2="21" gradientUnits="userSpaceOnUse">
                    ...
                    <div style={{ textAlign: "center" }}>
                        <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#ffffff", letterSpacing: "-0.03em", margin: "0 0 4px" }}>Přihlášení</h1>
                        <p style={{ color: "rgba(255,255,255,0.38)", fontSize: "0.8125rem", margin: 0 }}>Zadejte své přihlašovací údaje</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "14px", width: "100%" }}>
                    ...
                    >
                        {loading ? (<><Spinner />Přihlašuji...</>) : "Přihlásit se"}
                    </button>
                </form>
